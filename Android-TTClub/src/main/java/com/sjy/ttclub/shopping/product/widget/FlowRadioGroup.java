package com.sjy.ttclub.shopping.product.widget;
        ...
        for (int index = 0; index < childCount; index++) {
            ...
            if (child.getVisibility() != View.GONE) {
                ...
                if (x > maxWidth) {
                    ...
                    x = (width + 20);
                    //重新设置现在Group的高度
                    if (HardwareUtil.windowWidth >= 720 && HardwareUtil.windowHeight > 800 && HardwareUtil
                            .windowHeight <= 1280) {
                        y = row * (height + 10) + (height + 20);
                    } else if (HardwareUtil.windowWidth > 720 && HardwareUtil.windowHeight > 1280) {
                        y = row * (height + 20) + (height + 10);
                    } else {
                        y = row * (height + 10) + (height + 15);
                    }
                }
            }
        }
