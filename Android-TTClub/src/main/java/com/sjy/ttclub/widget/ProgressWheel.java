...
public class ProgressWheel extends View {
    ...
    private int barColor = Color.parseColor("#5588FF");
    private int rimColor = Color.parseColor("#00FFFFFF");
    ...
    private void parseAttributes(TypedArray a) {
        ...
        fillRadius = a.getBoolean(R.styleable.ProgressWheel_matProg_fillRadius, true);
